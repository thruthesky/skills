...
#   역할: cowork 분석이 끝나 final-report.md 가 만들어진 작업을 찾아, 그 final-report.md 를 6 AI
#         (claude·codex·copilot-grok·copilot-mai·kimi·agy)로 한 번 더 재검토(리뷰 라운드)하도록 백그라운드에 던진다.
#
# 설계 요지
