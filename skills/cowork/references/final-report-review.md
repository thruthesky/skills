...
④ [백그라운드] cowork.sh --review <name>
     ...
     ├─ 최대 5 AI 리뷰(병렬, 1-pass): 리뷰 페르소나 + final-report.md 전문 + 5개 cowork.md 전문
...
claude·codex·grok·kimi·agy 다섯 AI 의 분석을 오케스트레이터가 하나로 종합한 것이고, 당신의 임무는
...
- **5개 원본 분석**(`claude/codex/grok/kimi/agy-cowork.md`) — 종합의 재료. 종합본이 이것들을 정확히·공정히
...
최대 5개 리뷰를 받아 `final-report.md` 를 개선하는 종합 AI(claude)에게 주입한다. claude 도 읽기 전용이라
...
다섯 AI 가 검토한 리뷰 중 생성에 성공한 것들이 실려 있다. 리뷰의 지적을 반영해 `final-report.md` 를 **한 단계 더 정확하게**
다듬어라.
...
> 5 AI 리뷰(claude·codex·grok·kimi·agy) → claude 종합 → final-report.md 갱신
